  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      resizeTimeout = setTimeout(() => {
        ...
        // Use adaptive resolution based on screen size
        const adaptiveScale = Math.min(resolutionScale, w > 1920 ? 0.8 : 1);
        renderer.setSize(w * adaptiveScale, h * adaptiveScale);
    ...
    // Use requestIdleCallback when available for better main thread management
    ...
    const loop = (currentTime: number) => {
      if (isVisible && currentTime - lastTime >= frameInterval) {
        // Schedule the actual rendering work during idle time
        scheduleRender(() => {
