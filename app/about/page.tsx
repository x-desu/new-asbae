...
import { ArrowRight, ChevronDown, Sparkles, Users, Target, BarChart, Zap, Shield } from "lucide-react";
  ...
  return (
    <div>
      ...
      <div className="pt-20">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <motion.h1
                ...
                className="text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/80 mb-6"
              >
              ...
              >
                We're on a mission to democratize AI technology and make it accessible to businesses of all sizes. Our team of experts is dedicated to creating innovative solutions that drive real results.
              </motion.p>
        ...
        {/* Team Section */}
        <section id="team" className="py-16 bg-gradient-to-b from-background to-foreground/5">
          <div className="container mx-auto px-4">
            <motion.div 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {teamMembers.map((member, index) => (
                <motion.div
                  key={member.name}
                  className="glassmorphic p-6 rounded-2xl"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  transition={{ duration: 0.5, delay: index * 0.1 }}
                >
                  <div className="w-24 h-24 rounded-full bg-foreground/10 mb-4 mx-auto"></div>
        ...
        {/* FAQ Section */}
        <section id="faq" className="py-16 bg-gradient-to-b from-foreground/5 to-background">
          <div className="container mx-auto px-4">
            <motion.div 
              className="text-center mb-16"
              initial={{ opacity: 0, y: 20 }}
            ...
            <motion.div
              className="max-w-3xl mx-auto glassmorphic p-8 rounded-2xl"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
